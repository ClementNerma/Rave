    ...
    global: {
      patterns: [
        ...
        [
          ...
          /#__magic_(?:iterate_tuple|clone|serialize|unserialize|cast|cast_unsafe|proxy|flex_proxy|is_same|import|reference_level|arguments|return_type|set_primitive|random_primitive)/,
          'orange'
        ],
        [
