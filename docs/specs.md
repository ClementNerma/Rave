...
While non-plain values have a simple type (like `int`), plain values use the `#pln<[Type]>` templated type directive. For example, a plain 32-bit signed integer will have the `#pln<int>` type.
